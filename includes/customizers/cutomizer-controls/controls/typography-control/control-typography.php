...
class Customizer_Typo_Control_Typography extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			...
			array(
				...
				'weight'      => esc_html__( 'Font Weight', 'ctypo' ),
				'style'       => esc_html__( 'Font Style',  'ctypo' ),
	...
	public function ctypo_customize_controls_register_scripts() {
	...
	public function get_font_weight_choices() {
		...
		return array(
			'100' => esc_html__( 'Thin',       'ctypo' ),
			'300' => esc_html__( 'Light',      'ctypo' ),
			'400' => esc_html__( 'Normal',     'ctypo' ),
			'500' => esc_html__( 'Medium',     'ctypo' ),
			'700' => esc_html__( 'Bold',       'ctypo' ),
			'900' => esc_html__( 'Ultra Bold', 'ctypo' ),
		);
	}
	...
	public function get_font_style_choices() {
		...
		return array(
			'normal'  => esc_html__( 'Normal', 'ctypo' ),
			'italic'  => esc_html__( 'Italic', 'ctypo' ),
			'oblique' => esc_html__( 'Oblique', 'ctypo' )
		);
	}
}
